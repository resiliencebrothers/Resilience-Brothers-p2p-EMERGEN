...
const empty = { name: "", description: "", image_url: "", price_usd: 0, stock: 0, category: "general", is_active: true };
        ...
        <DialogContent className="bg-[#141414] border-white/10 text-white rounded-none">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div><Label className="micro-label text-neutral-500">Precio USD</Label><Input data-testid="prod-price" type="number" step="any" value={form.price_usd} onChange={e => setForm({ ...form, price_usd: e.target.value })} className="rounded-none mt-1 bg-[#0a0a0a] border-white/10 font-mono" /></div>
